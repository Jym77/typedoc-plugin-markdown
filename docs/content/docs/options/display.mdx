...
<Callout>Hide the page header.</Callout>
...
<Callout>Hide the page breadcrumbs.</Callout>
...
<Callout>Hide the page title.</Callout>
...
<Callout>
  Expand parameters and type parameters inside signatures.
</Callout>
...
<Callout>Sets the format of index items.</Callout>
...
<Callout>Sets the format of parameter and type parameter groups.</Callout>

> Accepts one of `"list"` | `"table"` | `"htmlTable"` | `"none"`. Defaults to `"list"`.
...
<Callout>Sets the format of property groups for interfaces.</Callout>
...
<Callout>Sets the format of property groups for classes.</Callout>
...
<Callout>Sets the format of style for type alias properties.</Callout>
...
<Callout>Sets the format of enumeration members.</Callout>
...
<Callout>Sets the format of style for type declaration members.</Callout>
...
<Callout>Configure page title output with placeholders.</Callout>
...
<Callout>Control how table columns are configured and displayed.</Callout>
